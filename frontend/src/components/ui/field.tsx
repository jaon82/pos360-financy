  ...
  return (
    <Label
      ...
      className={cn(
        ...
        'leading-5 font-medium text-sm text-gray-700',
...
function FieldDescription({ className, ...props }: React.ComponentProps<'p'>) {
  return (
    <p
      ...
      className={cn(
        'text-left text-xs leading-4 font-regular text-gray-500 group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5',
